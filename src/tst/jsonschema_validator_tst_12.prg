...
static function getJSONSchema(/*@*/cErrorMsg as character)

    local cURL as character:="http://json-schema.org/draft-04/schema#"
    local cJSONSchema as character

    __cURLGet(cURL,@cJSONSchema,@cErrorMsg)

    return(cJSONSchema)

static function getJSONData(/*@*/cErrorMsg as character)
    ...
    __cURLGet(cURL,@cJSONData,@cErrorMsg)

    return(cJSONData)

static function __cURLGet(cURL as character,cResponse as character,/*@*/cErrorMsg)
