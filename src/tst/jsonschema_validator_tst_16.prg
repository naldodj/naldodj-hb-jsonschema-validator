...
|__/
    ...
    --------------------------------------------------------------------------------------
*/
static function getTst16(cSchema as character)
    ...
    #pragma __cstream|cSchema:=%s
{
    ...
    aTests:={;
       ...
       ,{"Invalid case: This is a key that doesn't match any of the regular expressions and not allowed with additionalProperties",'{ "keyword": 0 }',.F.};
    }
